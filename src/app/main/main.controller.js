(function() {
  ...
  function MainController($timeout, toastr, $http, $log, $auth, $state) {
    ...
    vm.facebookPost = function(id){
      var url = 'https://graph.facebook.com/me/feed?message=http://dev.corona.geekies.co:8000/#/register?referreal_code='+id+'&access_token='+localStorage.getItem("token_facebook")+'';
